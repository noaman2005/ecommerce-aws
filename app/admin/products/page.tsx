                ...
                filteredProducts.map((product) => (
                  <tr key={product.id} className="transition hover:bg-[#fff8f1]">
                    <td className="px-6 py-4">
                      ...
                      <div className="text-xs text-[#5f4b3f] line-clamp-1">{product.description}</div>
                    </td>
                    <td className="px-6 py-4 text-sm text-[#5f4b3f]">{product.categoryId || "—"}</td>
                    <td className="px-6 py-4 text-sm text-[#1c1a17]">${product.price.toFixed(2)}</td>
              ...
              filteredProducts.map((product) => (
                <div key={product.id} className="rounded-2xl border border-[#f1e3d5] bg-[#fffdf8] p-4 space-y-3">
                  <div>
                    ...
                    <p className="text-xs text-[#5f4b3f] line-clamp-2">{product.description}</p>
                  </div>
                  <div className="grid grid-cols-2 gap-2 text-sm text-[#5f4b3f]">
                    ...
                    <div className="text-right">
                      ...
                      <p className="font-semibold text-[#1c1a17]">${product.price.toFixed(2)}</p>
                    </div>
                    <div>
